...
mix.js('assets/src/scripts/app.js', 'assets/dist/js')
	...
	.js('assets/src/scripts/react/reset-password', 'assets/dist/js/react').react().extract()
	.js('assets/src/scripts/react/user-register', 'assets/dist/js/react').react().extract()
	.js('assets/src/scripts/blocks/popular-services', 'assets/dist/js/blocks').extract()
	.js('assets/src/scripts/blocks/find-services', 'assets/dist/js/blocks').extract()
	.js('assets/src/scripts/blocks/recent-users', 'assets/dist/js/blocks').extract()
	.js('assets/src/scripts/blocks/search-users', 'assets/dist/js/blocks').extract()
