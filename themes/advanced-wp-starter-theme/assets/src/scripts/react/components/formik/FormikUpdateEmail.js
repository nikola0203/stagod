...
function FormikUpdateEmail(props) {
  ...
  return (
    <>
      <div className="border p-4 p-xl-8 mb-6 rounded-4 bg-white d-flex align-items-center justify-content-between" type="button" data-bs-toggle="modal" data-bs-target="#modal-update-email">
        <div>
          <div className='h5 mb-0 fw-bold'>Promena e-maila</div>
      ...
      <div className="modal fade" id="modal-update-email" tabIndex="-1" aria-labelledby="modal-label-update-email" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content p-4 p-xl-8">
            ...
            <h2 className="h3" id="modal-label-user-update-email">Promena e-maila</h2>
            ...
            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
              {
                (formik) => <Form>
                  ...
                  <div className='d-flex align-items-center'>
                    <button type='submit' className='btn btn-primary me-4'>Promeni email</button>
                  ...
                  {(errorMessage) ? <div className='alert alert-warning mt-6'>Email adresa je ista kao i trenutna.</div> : ''}
                </Form>
              }
            </Formik>
          </div>
